...
def scrap_new_castle_county_delaware(
    ...
    try:
        ...
        time.sleep(6)
        # Locate the table
        table = find_element_with_retry(driver_instance, By.CLASS_NAME, "table")
        ...
        for i in range(ord("a"), ord("z") + 1):
            ...
            dropdown = find_element_with_retry(
                driver_instance, By.XPATH, '//*[@id="main_content"]/select'
            )
        ...
        df.loc[empty_rows, "Address (Sheriff's Sale)"] = df.loc[
            empty_rows, "First Name"
        ]
        ...
        df[["Address", "City", "Zip Code"]] = df["Address"].apply(
            split_and_update_address
        )
